...
class WatchlistTestCase(unittest.TestCase):
    ...
    def test_404_page(self):
        response = self.client.get('/nothing')  # enter invalid page
    ...
    def test_create_item(self):
        ...
        # Test creating blank title movie
        response = self.client.post('/', data=dict(
            title='',
            year='2019'
        ), follow_redirects=True)
        ...
        # Test creating blank year movie
        response = self.client.post('/', data=dict(
            title='New Movie',
            year=''
        ), follow_redirects=True)
